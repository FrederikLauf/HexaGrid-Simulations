...
class HexaGrid:
    ...
    def make_direction(self,cell,direction):
        """Return cell in direction from current cell, or False if not possible.
        
        Odd rows are interpreted as being shifted half a unit to the right and the
        cartesic coordinates are determined from direction correspondingly.
        """
